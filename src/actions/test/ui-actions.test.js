...
describe("ui actions", () => {
    ...
    it("validateSearchTerm", () => {
        const expected = {
            type: "VALIDATE_SEARCH_TERM",
            payload: "search"
        };
        const searchTerm = "search";
        const action = actions.validateSearchTerm("search");
        expect(action).toEqual(expected);
    });
    it("setSearchValidationError", () => {
        const expected = {
            type: "SET_SEARCH_VALIDATION_ERROR",
            payload: "Validation Error"
        };
        const validationError = "Validation Error";
        const action = actions.setSearchValidationError(validationError);
        expect(action).toEqual(expected);
    });
});
